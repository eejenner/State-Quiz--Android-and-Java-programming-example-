...
private List<String> quizStatesList; // countries in current quiz
   ...
   Bundle savedInstanceState)
{
   ...
   questionNumberTextView.setText(
      getResources().getString(R.string.question, 1, STATES_IN_QUIZ));
...
{      
   ...
   quizStatesList.clear(); // clear prior list of quiz countries
   ...
   while (flagCounter <= STATES_IN_QUIZ) 
   {
      ...
      {
         quizStatesList.add(fileName); // add the file to the list
         ++flagCounter;
      } 
   } 

   loadNextState(); // start the quiz by loading the first flag
...
private void loadNextState() 
{
   ...
   try
   {
      ...
      InputStream stream = 
         assets.open("states/" + nextImage + ".png");
   ...
   String stateName = getCountryName(correctAnswer);
